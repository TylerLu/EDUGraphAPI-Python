...
class MSGraphService(object):
    ...
    def get_client(self):
        self.auth_provider.access_token(self.access_token)
    ...
    def get_photo(self, object_id):
        ...
        photo_content = self.rest_api_service.get_img(url, self.access_token)
        if photo_content:
            photo = photo_content
        return photo
    ...
    def get_documents(self, object_id):
        ...
        documents_list = self.rest_api_service.get_object_list(url, self.access_token, model=Document)
