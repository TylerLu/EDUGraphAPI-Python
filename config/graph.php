...
class Constants
{
    const CLIENT_ID          = '768c5329-a192-4086-834d-d491b17ffb2d';
    const CLIENT_SECRET      = '7pw3MnehkiwVYDWnyPyTdv2';
    const REDIRECT_URI       = 'https://api.zhiwenlive.com/account/oauth';
