...
2. Create a new file named **evn.bat** in the same directory as **manage.py**. Add two new keys **ClientId** and **ClientSecret**. These keys will be used to identity in your apps with Windows Azure Active Directory.
