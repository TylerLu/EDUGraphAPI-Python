"""
Django settings for EDUGraphAPI project.
...
SECRET_KEY = 'y08w@_^2fv6546u(gj)lck$#2*xm)265ov$w*7-5a7449sb7l@'
...
WSGI_APPLICATION = 'EDUGraphAPI.wsgi.application'
